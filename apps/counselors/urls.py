...
urlpatterns = [
    ...
    path('reviewed/', views.reviewed_submissions, name='reviewed_submissions'),
    path('reset_submission/<int:submission_id>/', views.reset_submission, name='reset_submission'),
